    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbar-collapse-1">
            <ul class="nav navbar-nav">
                <li class="active"><a href="${pageContext.request.contextPath}/user/userbasis.jsp"><fmt:message key="main"/></a></li>
    ...
    <div class="container">
        ...
        <div class="container">
            <div class="pull-right">
                <a href="${pageContext.request.contextPath}/userListRoute" class="btn btn-default"><fmt:message key="route.list.all"></fmt:message> </a>
            </div>
            <div align="center">
