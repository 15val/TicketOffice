    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbar-collapse-1">
            ...
            <ul class="nav navbar-nav navbar-right">
                ...
                <li class="active"><a href="${pageContext.request.contextPath}/register.jsp" class="btn btn-success"><fmt:message key="or.register"/></a></li>
                <li class="dropdown">
...
<div id="regErrorModal" class="modal fade" tabindex="-1">
    <div class="modal-dialog modal-sm">
        <div class="modal-content">
            <div class="modal-header">
                <button class="close" data-dismiss="modal">X</button>
                <h4 class="modal-title"><fmt:message key="register.error"/></h4>
            </div>
            <div class="modal-body">${validationError}</div>
...
<c:if test="${not empty validationError}">
    <script>
        ...
        $('#regErrorModal').on('hidden.bs.modal', function (event){
...
<div class="jumbotron">
    <div class="container">
        <h1><fmt:message key="enter.data"/> </h1>
    <form class="form-horizontal" method="post" action="${pageContext.request.contextPath}/register">
        ...
        <div class="form-group">
            <label for="role" class="control-label"><fmt:message key="role"/> </label>
        </div>
        <select class="form-select" id="role" name="role">
            <option selected value="USER"><fmt:message key="role.user"/> </option>
        ...
        <div class="pull-right">
            ...
            <button type="submit" class="btn btn-success"><fmt:message key="or.register"/></button>
        </div>
